...
* Card 1 has five winning numbers (41, 48, 83, 86, and 17) 
    * You have eight numbers (83, 86, 6, 31, 17, 9, 48, and 53)
...
* Original card 2 has two matching numbers
    * You win one copy each of cards 3 and 4.
* Copy of card 2 
    * Also wins one copy each of cards 3 and 4.
* Four instances of card 3 (one original and three copies) 
    * Two matching numbers
    * You win four copies each of cards 4 and 5.
* Eight instances of card 4 (one original and seven copies)
    * One matching number
    * You win eight copies of card 5.
* Fourteen instances of card 5 (one original and thirteen copies)
    * No matching numbers 
    * You win no more cards.
* One instance of card 6 (one original)
    * No matching numbers
    * You win no more cards.
...
Process all of the original and copied scratchcards until no more scratchcards are won. <br>
